function iniciarApp(){
    ...
    function mostrarRecetas(recetas = []){
        ...
        recetas.forEach(receta=>{
            ...
            recetaButton.onclick = function (){ //Esto es un callback!! 
    ...
    function mostrarRecetaModal(receta){
        ...
        modalBody.innerHTML = `
            ...
            <h3 class="my-3">Instrucciones</3>
            <p class="instrucciones-p">${strInstructions}</p>
            <h3 class="my-3">Ingredientes y cantidades</3>
        `;
        ...
        limpiarHTML(modalFooter); //Limpiamos el html para no repetir botones
